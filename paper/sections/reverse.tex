\section{Automatic Differentiation} \label{sec:ad}
    ...
    \subsection{The Reverse Pass}
        ...
        In Listing \ref{lst:reverse_def} we define a new data type for adjoints: one for arrays, one for real values, and a ``null'' value we can use as a placeholder.
