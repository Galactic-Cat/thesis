...
\section{Automatic Differentiation} \label{sec:ad}
    ...
    \subsection{Differentiating Operations}
        ...
        \subsubsection{The reverse pass on fold operations}
            ...
            \cc{Dit neemt aan een stukje in de tracing bestaat over waarom een vectorized fold maar uit twee stappen bestaat, maar dat moet ik er nog bij schrijven (inclusief alle referenties naar fold in het algemeen)}
